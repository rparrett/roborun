...
fn main() {
    ...
    let body_handle = world.add_rigid_body(body_pos, body_inertia, body_com);

    world.add_collider(COLLIDER_MARGIN, body_shape, body_handle, body_pos, Material::default());
